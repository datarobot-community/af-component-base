...
See [Harness](https://developer.harness.io/docs/platform/pipelines/input-sets/) documentation to find out more
about the input sets and the [pipelines](https://developer.harness.io/docs/platform/pipelines/) in general.
