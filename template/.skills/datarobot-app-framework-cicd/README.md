...
- [Upstream skill source](https://github.com/datarobot-oss/datarobot-agent-skills/tree/main/skills/datarobot-app-framework-cicd) - Canonical source in `datarobot-agent-skills`
...
This skill is bundled from the [datarobot-agent-skills](https://github.com/datarobot-oss/datarobot-agent-skills/tree/main/skills/datarobot-app-framework-cicd) repository. To contribute or get the latest version, open a PR there. Changes should then be synced into downstream template copies.
