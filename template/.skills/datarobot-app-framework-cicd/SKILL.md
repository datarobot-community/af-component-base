...
- [Upstream skill source (datarobot-agent-skills)](https://github.com/datarobot-oss/datarobot-agent-skills/tree/main/skills/datarobot-app-framework-cicd) — canonical source; this bundled copy should be kept in sync
